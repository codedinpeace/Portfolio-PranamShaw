...
const Hero = () => {
  ...
  <div className="w-px h-[60.875rem] max-md:h-[40.875rem]  bg-black"></div>
      ...
      <div className=" socials max-md:mt-7 flex justify-center gap-50 max-lg:gap-20 max-md:gap-15 max-xl:gap-40 mt-15">
        <a href="https://www.instagram.com/__i.am.alive__/"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 90 90" fill="none" className='hover:opacity-70 transition-all duration-150 max-xl:w-10 max-xl:h-10 max-lg:w-8 max-md:w-5'>
        ...
        <a href="https://x.com/PranamShaw"><svg xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 91 90" fill="none" className='hover:opacity-70 transition-all duration-150 max-xl:w-10 max-xl:h-10 max-lg:w-8 max-md:w-5'>
        ...
        <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 91 90" fill="none" className='hover:opacity-70 transition-all duration-150 max-xl:w-10 max-xl:h-12 max-md:w-5 max-md:h-10'>
