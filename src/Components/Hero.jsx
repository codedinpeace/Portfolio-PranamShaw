  ...
  return (
    <div className='mt-20 w-[100%] h-[100vh]'>
      ...
      <div className=" socials max-md:mt-7 flex justify-center gap-50 max-lg:gap-20 max-md:gap-15 max-xl:gap-40 mt-15">
        ...
        <a href="https://www.linkedin.com/in/pranam-shaw-1504ba359/ "><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50 " viewBox="0 0 89 89" fill="none" className='hover:opacity-70 transition-all duration-150 max-xl:w-10 max-xl:h-10 max-lg:w-8 max-md:w-5'>
          <path d="M25.7358 18.5417C25.7348 20.5087 24.9525 22.3947 23.5609 23.7849C22.1693 25.1751 20.2824 25.9556 18.3154 25.9546C16.3484 25.9536 14.4623 25.1713 13.0721 23.7797C11.6819 22.3881 10.9015 20.5013 10.9025 18.5342C10.9035 16.5672 11.6858 14.6811 13.0774 13.2909C14.469 11.9007 16.3558 11.1203 18.3228 11.1213C20.2899 11.1223 22.1759 11.9046 23.5661 13.2962C24.9563 14.6878 25.7368 16.5746 25.7358 18.5417ZM25.9583 31.4467H11.125V77.875H25.9583V31.4467ZM49.395 31.4467H34.6358V77.875H49.2466V53.5112C49.2466 39.9387 66.9354 38.6779 66.9354 53.5112V77.875H81.5833V48.4679C81.5833 25.5875 55.4025 26.4404 49.2466 37.6767L49.395 31.4467Z" fill="#2C2C2C" />
        </svg></a>
        <a href="https://github.com/codedinpeace"><svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 91 90" fill="none" className='hover:opacity-70 transition-all duration-150 max-xl:w-10 max-xl:h-12 max-md:w-5 max-md:h-10'>
